...
<div class="container">
    <h1>Nirob Finance Dairy</h1>
    <a href="https://https://youtube.com/@nirobsfinancedairy" target="_blank" class="developer">Nirob Finance Dairy</a>
    ...
    <div class="links">
        <a href="http://wa.me/8801827266022" target="_blank">Whatsapp Support</a>
    </div>
</div>

<!-- Monetag SDK -->
<script src='//libtl.com/sdk.js' data-zone='10284143' data-sdk='show_10284143'></script>
...
// Check SDK
function checkSDK(){
    if(typeof window.show_10284143 === 'function'){
        monetagLoaded = true;
